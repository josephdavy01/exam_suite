    ...
    <form method="POST">
        <div class="login" id="login">
            <div class="Forgot" id="1st">
                ...
                <input type="text" name="" id="email" class="password" placeholder="Email Id" />
                <input type="password" name="" id="email" class="password" placeholder="Password" />
                <button type="submit" class="submit" name="" onclick="register_now()">Change</button>
            ...
            <div class="registerpage" id="2nd">
                ...
                <input type="text" name="password" id="email" class="password" placeholder="Password" required />
                <button type="submit" class="submit" name="login" onclick="register_now()">Login</button>
