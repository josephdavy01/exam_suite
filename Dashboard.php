...
<body>
    ...
    <style>
        ...
        ul li:nth-child(3):hover~.active {
            top: 190px;
        }

        ul li:nth-child(4):hover~.active {
            top: 270px;
        }
    ...
    <div class="menu" id="menu">
        <ul class="ul">
            ...
            <li>
                <a href="#" id="dashboard"><i class="material-icons">dashboard</i>Dashboard</a>
            </li>
            <li>
        ...
        <div class="dashboard" id="dashboard1">
            <h3 style="position: absolute;left:750px;color:white;font-size:25px;font-family:Roboto;text-decoration:underline;">Dashboard</h3>
            <div class="frame1">
                <img src="vector 6.svg" style="position: absolute;height: 200px;width: 200px;left: 25px;border-radius: 45px;" class="vector6">
                <button class="start" onclick="navigate()">Exams</button>
            </div>
             <!-- <div class="frame2">
                <img src="vector 7.svg" style="position: absolute;height: 200px;width: 200px;left: 65px;border-radius: 45px;">
                <button class="start" onclick="navigate1()">Time Table</button>
            </div>-->
        </div>
    ...
    <script>
        ...
        //SMTP PASSWORD CFC4796DBBD2268B304B47D08486E7DC35B1
        //SMTP SECURE TOKEN dcd31f4a-e5f4-4410-a0f4-450d1bb92b78
        ...
        function navigate() {
            location.replace("http://localhost/Exam%20suite/subjects.php")
        }

        function navigate1() {
            location.replace("http://localhost/Exam%20suite/Timetable%20display.php")
        }
